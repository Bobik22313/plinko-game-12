...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-bf1d459a');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-bf1d459a');}
...
function clearFlash(){dieView.classList.remove('rl-win-bf1d459a');dieView.classList.remove('rl-lose-bf1d459a');if(frameEl){frameEl.classList.remove('rl-win-bf1d459a');frameEl.classList.remove('rl-lose-bf1d459a');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-bf1d459a');if(frameEl){frameEl.classList.add('rl-win-bf1d459a');}}else{dieView.classList.add('rl-lose-bf1d459a');if(frameEl){frameEl.classList.add('rl-lose-bf1d459a');}}
...
var brandEl=document.querySelector('.rl-brand-bf1d459a');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
